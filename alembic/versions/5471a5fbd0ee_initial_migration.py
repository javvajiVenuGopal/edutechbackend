...
Revision ID: 5471a5fbd0ee
Revises: 92150bedda4b
Create Date: 2026-04-13 21:38:28.804852
...
revision: str = '5471a5fbd0ee'
down_revision: Union[str, Sequence[str], None] = '92150bedda4b'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_guide_slots_id'), 'guide_slots', ['id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['referrer_id'], ['senior_guides.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_guide_slots_id'), table_name='guide_slots')
    op.drop_table('guide_slots')
